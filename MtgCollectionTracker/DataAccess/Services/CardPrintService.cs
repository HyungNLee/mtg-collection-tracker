...
namespace DataAccess.Services
{
	public class CardPrintService : ICardPrintService
	{
		...
		public async Task<CardPrint> GetCardPrintAsync(int cardId, int setId)
		{
			var storedProcedure = "CardPrint_SelectBy_CardId_SetId";
			...
			using IDbConnection dbConnection = new SqlConnection(_config.ConnectionString);
			var foundCardPrint = await dbConnection.QueryFirstOrDefaultAsync<CardPrint>(
				sql: storedProcedure,
				param: parameters,
				commandType: CommandType.StoredProcedure);
